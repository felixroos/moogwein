...
export const Weine = (props) => (
    <div>
        <table className="table">
            <thead>
                <tr>
                    <th className="align-left" colSpan="2">Preisliste 2018</th>
                    <th className="align-right"><strong>0.75l</strong></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    ...
                    <td className="align-right">12,50€ <br/><small>16,67€/l</small></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Trarbacher Schloßberg 2018</td>
                    <td>Riesling - Kabinett - feinherb</td>
                    <td className="align-right">8,00€ <br/><small>10,67€/l</small></td>
                </tr>
                <tr>
            ...
            <thead>
                <tr>
                    ...
                    <th className="align-right"><strong>0,5l</strong></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td className="align-right">9,50€ <br/><small>19€/l</small></td>
                </tr>
                <tr>
                    <td>Rieslingtresterbrand</td>
                    <td>5 Jahre im Eichenholzfass gereift</td>
                    <td className="align-right">14,50€ <br/><small>29€/l</small></td>
                </tr>
                <tr>
                    <td>Rieslingtresterbrand</td>
                    <td>10 Jahre im Eichenholzfass gereift</td>
                    <td className="align-right">23,50€ <br/><small>47€/l</small></td>
                </tr>
                <tr>
                    <td>Apfelbrand</td>
                    <td>im Eichenholzfass gereift</td>
                    <td className="align-right">14,00€ <br/><small>28€/l</small></td>
                </tr>
                <tr>
                    <td>Quitte</td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td className="align-right">16,50€ <br/><small>33€/l</small></td>
                </tr>
            </tbody>
        </table>
